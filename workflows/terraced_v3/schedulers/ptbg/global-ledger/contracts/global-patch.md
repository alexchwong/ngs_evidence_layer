...
Within a replacement domain, preserve every still-correct surfaced `statement` and its `case_refs` exactly. Return card-tag fields empty; evidence provenance is assigned separately downstream.
