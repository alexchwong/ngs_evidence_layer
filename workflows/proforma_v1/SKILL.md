...
Proforma-v1 has one shared clinical/proforma workflow and two execution engines.

## Provider routing

- No provider selector, or explicit `--self`: use `workflows/proforma_v1/self.py`. `self` is the default.
- Explicit non-self provider (`lmstudio`, `openrouter`, or another registered staged pipeline): use the existing `workflows/proforma_v1/step.py` path unchanged.
...
```bash
python workflows/proforma_v1/self.py structure --work-dir <work-dir>
# Read the printed structure_case contract/inputs and write case.json.
# Stay in the same WHO1 reasoning pass:
python workflows/proforma_v1/self.py who1 --work-dir <work-dir>
# Read printed WHO5 inputs and write WHO1 output.

python workflows/proforma_v1/self.py icc --work-dir <work-dir>
# Write ICC output.

python workflows/proforma_v1/self.py who2 --work-dir <work-dir>
# Write authoritative WHO2 output.

python workflows/proforma_v1/self.py ptbg --work-dir <work-dir>
...
python workflows/proforma_v1/self.py evidence-resolution --work-dir <work-dir>
# Write the shared evidence-match output.

python workflows/proforma_v1/self.py evidence-audit --work-dir <work-dir>
# Write the shared evidence-audit output.

python workflows/proforma_v1/self.py evidence-adjudication --work-dir <work-dir>
...
python workflows/proforma_v1/self.py finalize-evidence --work-dir <work-dir>

python workflows/proforma_v1/self.py report --work-dir <work-dir>
# Read the existing report-write contract, ORIGINAL case.md, and deterministic report context; write report-write.yaml.

python workflows/proforma_v1/self.py finalize-report --work-dir <work-dir>
...
For non-self providers, continue to use `workflows/proforma_v1/step.py` with its existing work-directory behaviour unchanged.
