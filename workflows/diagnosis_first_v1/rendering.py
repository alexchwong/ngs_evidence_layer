"""Diagnosis-first-v1 evidence rendering policy."""
...
def render_to_files(
    ...
    *,
    ...
    if bundle.get("workflow_profile") != "diagnosis-first-v1":
        raise ValueError("diagnosis-first renderer requires a diagnosis-first-v1 bundle")
    if retrieved_only:
        bundle = dict(bundle)
