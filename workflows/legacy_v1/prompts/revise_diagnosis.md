...
Use only the user's requested revised diagnostic label/downstream category, `diagnostic_evidence.md`, `ngs-panel-scope.md`, and the existing `adjudication.json`. Apply the shared patient-result semantics in `workflows/legacy_v1/SKILL.md`.
