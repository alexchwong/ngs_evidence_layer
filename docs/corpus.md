...
| `flt3-ras-gilteritinib-resistance` | `10.1182/bloodadvances.2021006489` | ADMIRAL Gilteritinib Molecular Resistance 2022 | Gilteritinib response and resistance in FLT3-mutated AML, including emergent RAS/MAPK and FLT3 F691L resistance. |
| `koster-2024-vexas-pdf` | `10.1002/ajh.27156` | Koster VEXAS Review 2024 | UBA1-mutated VEXAS diagnosis, haematologic associations, molecular features, prognosis, and management. |
| `liu-2025-germline-myeloid` | `10.1146/annurev-pathmechdis-111523-023420` | Liu 2025 Inherited Myeloid Predisposition Review | Inherited myeloid predisposition syndromes, genotype-phenotype relationships, testing, surveillance, and management. |
| `luque-paz-2023-blood-mpn` | `10.1182/blood.2022017578` | Luque Paz MPN Molecular Profiling Review 2023 | MPN driver and additional mutations affecting diagnosis, phenotype, progression, prognosis, and molecular profiling. |
| `marando-2025-cmml` | `10.3324/haematol.2024.286061` | Marando CMML Molecular Review 2025 | CMML molecular pathogenesis, prognostic mutations, progression biology, and genotype-informed therapeutic considerations. |
| `marchand-2024-lgl-pdf` | `10.1111/bjh.19476` | Marchand LGL Leukemia Review 2024 | LGL leukaemia JAK/STAT biology and ruxolitinib response evidence in relapsed or refractory disease. |
| `paolino-2024-ikzf1-all` | `10.3390/biomedicines12010089` | Paolino IKZF1 B-ALL Review 2024 | IKZF1-altered B-ALL biology, prognostic impact, biomarker roles, and treatment-targeting implications. |
| `ustun-2025-systemic-mastocytosis-pdf` | `10.1182/bloodadvances.2024012612` | Ustun Systemic Mastocytosis 2025 | Systemic mastocytosis diagnosis, KIT-centred molecular testing, prognostic markers, and targeted treatment. |
| `vainchenker-2017-mpn` | `10.1182/blood-2016-10-695940` | Vainchenker & Kralovics 2017 MPN review | Classical MPN driver biology, additional mutations, inherited susceptibility, phenotype, and transformation. |
| `xie-2024-ccrs-ccus` | `10.1182/blood.2024024756` | Xie CCRS 2024 | CCUS risk prediction using mutation patterns, platelet count, mutation burden, transformation risk, and survival. |
...
block for each paper that has one. The card browser is read-only and never loads or
edits a CUL profile; use `python scripts/cul.py --edit` for CUL editing. The generated
file is written to `output/reports/card-browser.html`; the compact release payload
does not need to ship it for case execution.
