...
For `nel-validate <case-id>` or `nel-validate-function <case-id>`, record `<validation-case>` only. Do not read validation marking files. For `nel-validate-function`, `validation/case_functional_manifest.md` is also forbidden model input.
...
Do not model-read `validation/case_functional.md`, `validation/case_functional_manifest.md`, or marking criteria.
