...
The diagnostic R0-R1 rule view was generated in Step 0 as `<work-dir>/reporting-rules-dx.md`; do not regenerate it here. It uses the prompt-owned diagnosis template under `prompts/workflow/prototype/`, injects the shared `prompts/workflow/reporting_rule_policy.md`, and contains only canonical R0-R1 rules.
