...
Generate the diagnostic rule view exactly:
...
Follow the prototype diagnosis prompt and write only `<work-dir>/report-draft-dx.md`.
...
First generate the rule subset and branch state exactly:
...
Write only `<work-dir>/report-draft-remainder.md`.
